...
CIMS_UI_PAGES_LOCATION = 'cims_ui_pages'
...
ALL_PAGE_NAMES = [
    ...
    'multiple_entries_original', 'multiple_entries_results',
    'multiple_entries', 'uprn_multiple_entries', 'custom_response', 'help',
    'settings'
]

DEFAULT_BULK_LIMITS = {
    'limit_mini_bulk': 5000,
    'limit_vast_bulk': 10000,
...
USER_GROUPS = [
    {
        ...
        'pages_to_remove': [
            'custom_response', 'singlesearch', 'uprn', 'postcode', 'typeahead',
            'uprn_multiple_entries', 'custom_response', 'help', 'settings'
        ],
    ...
    },
    {
        ...
        'pages_to_remove': [
            'singlesearch', 'uprn', 'postcode', 'typeahead',
            'multiple_entries_original', 'uprn_multiple_entries',
            'multiple_entries', 'multiple_entries_results',
            'uprn_multiple_entries', 'custom_response', 'help', 'settings'
        ],
        'bulk_limits': DEFAULT_BULK_LIMITS,
    },
