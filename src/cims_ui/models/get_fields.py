...
# from cims_ui import get_epoch_options_cached
...
def get_fields(endpoint_name, include_UPRN_redirect=False):
  ...
  common_fields = {
      ...
      'multiple_entries_paf_nag_preference':
      Field(
          'paf-nag-preference',
          search_type='radio',
          flag=False,
  ...
  elif endpoint_name == 'multiple_entries_original':
    return ([
        Field(
            'limit',
            display_title="Limit",
  ...
  elif endpoint_name == 'uprn_multiple_entries':
    return ([
        common_fields['header_row_export'],
    ])
