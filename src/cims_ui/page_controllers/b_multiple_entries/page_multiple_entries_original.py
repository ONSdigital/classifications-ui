...
# from .utils.multiple_entries_lookup import multiple_entries_match_original
from .utils.upload_utils import check_valid_upload, FileUploadException

page_name = 'multiple_entries_original'
...
def multiple_entries_original():
  ...
  if not file_valid:
    ...
    #   try:
    #     full_results, line_count = multiple_entries_match_original(
    ...
    #   try:
    #     table_results, results_summary_table = multiple_entries_match_original(
