...
from .utils.multiple_entries_lookup import uprn_multiple_entries_match_original
...
page_name = 'uprn_multiple_entries'


@login_required
@app.route(f'/{page_name}', methods=['GET', 'POST'])
def uprn_multiple_entries():
  ...
  if request.method == 'POST':
    ...
    try:
      full_results, line_count = uprn_multiple_entries_match_original(
          file, all_user_input)
