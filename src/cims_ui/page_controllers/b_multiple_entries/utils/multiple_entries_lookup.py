...
# from cims_ui.models.get_addresses import get_addresses
# from .upload_utils import remove_script_and_html_from_str
from cims_ui.page_error import page_error
from cims_ui.page_helpers.api.api_interaction import api, submit_mm_job, submit_uprn_mm_job, get_response_attributes

page_name = 'multiple_entries_submit'
...
#                  multiple_entries_total, no_match_total):
...
#       ]
#       answers = [
#           no_addresses_searched, single_match_total, multiple_entries_total,
#           no_match_total
#       ]
...
#     elif no_results > 1:
#       multiple_entries_total += no_results
#     elif no_results == 0:
#       no_match_total += 1
#
...
#
#
# def uprn_multiple_entries_match_original(file, all_user_input):
