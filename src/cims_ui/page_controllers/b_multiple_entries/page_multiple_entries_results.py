...
from .utils.multiple_entries_utils import get_tag_data, job_data_by_current_user
from cims_ui.page_helpers.security_utils import check_user_has_access_to_page
from cims_ui.page_helpers.table_utils import create_table
...
from cims_ui.page_helpers.api.api_interaction import job_result_formatter
from cims_ui.page_helpers.google_utils import get_username, get_current_group

page_name = 'multiple_entries_results'


@login_required
@app.route(f'/multiple_entries_results', methods=['GET', 'POST'])
def multiple_entries_results():
